...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:fd35eedabb304eb698c9f44d342ad8bf";
const SUDO = process.env.SUDO || '24160373332';
...
const STICKER_DATA = process.env.STICKER_DATA || "Altesse_Salomon";
